...
uv run --project demo/uv-demo pytest --junitxml demo/uv-demo/pytest-junit.xml
uv run --project demo/uv-demo ruff check demo/uv-demo/src --output-format json --output-file demo/uv-demo/ruff-results.json
